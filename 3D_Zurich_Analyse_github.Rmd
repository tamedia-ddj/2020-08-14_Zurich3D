...
```{r store, eval = FALSE, echo = FALSE, results = "hide"}
# store new current file
file_html = "3D_Zurich_Analyse_fancy_2.html"
setwd(url_wd)
print(getwd())    
# --> store html here

url_ftp <- paste("ftp://interaktiv.tagesanzeiger.ch/datenteam/", file_html, sep = "")

## upload stored html
ftpUpload(file_html, url_ftp, userpwd = "patrick:$XzvyPD-?G6(gxq#")
url_html <- paste("interaktiv.tagesanzeiger.ch/datenteam/", file_html, sep = "")
print(url_html)
